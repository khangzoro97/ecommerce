...
<div class="product-details"><!--product-details-->
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p><img src="{{asset('frontend/images/product-details/rating.png')}}" alt="" /></p>

            <form action="{{route('save_cart')}}" method="post">
                @csrf
            <span>
                <span>{{number_format($value->product_price,0,',','.')}} VNĐ</span><br><br><br>
...
<div class="category-tab shop-details-tab"><!--category-tab-->
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="details" >
            <p style="font-size: 18px"><b>Mô tả sản phẩm: </b>{!!$value->product_desc!!}</p>
        </div>

        <div class="tab-pane fade" id="companyprofile" >
            <p style="font-size: 18px"><b>Chi tiết sản phẩm: </b>{!!$value->product_content!!}</p>
        </div>
